  ...
  const handleFileUpload = (event) => {
    ...
    reader.onload = (e) => {
        try {
            ...
            const sheetName = workbook.SheetNames.find(name => name.toLowerCase().trim() === 'employees');
            if (!sheetName) {
                throw new Error(`Excel file must contain a sheet named "Employees".`);
            }
            ...
            const nameHeader = findHeader(firstRow, 'Name');
            const roleHeader = findHeader(firstRow, 'Role');
